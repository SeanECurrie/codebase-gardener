...
def test_security_input_sanitization():
    ...
    for path in dangerous_paths:
        ...
        assert ("does not exist" in result or 
                "system directories is not allowed" in result or
                "Invalid directory path" in result)
...
def test_analysis_prompt_generation_edge_cases():
    ...
    for file_count, byte_count, expected_depth in test_cases:
        ...
        if expected_depth == "minimal":
            assert "small project" in prompt.lower() or "brief analysis" in prompt.lower()
        elif expected_depth == "focused":
            assert "focused project" in prompt.lower() or "main aspects" in prompt.lower()
        elif expected_depth == "comprehensive":
            assert "comprehensive" in prompt.lower() or "detailed analysis" in prompt.lower()
